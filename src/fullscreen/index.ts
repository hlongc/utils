...
export function isFullscreen(): boolean {
  return (
    !!getFullscreenElement() || window.innerHeight === window.screen.height
  );
}
...
export async function enterFullscreen(
  element: EnhancedHTMLElement = document.body,
 ...
 */
export function listenFullscreen(
 ...
 */
export function unlistenFullscreen(
  callback: EventListener,
